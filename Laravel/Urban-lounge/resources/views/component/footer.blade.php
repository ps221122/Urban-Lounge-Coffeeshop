<footer class="rounded-md p-4 shadow md:px-6 md:py-0">
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <ul class="mb-6 flex flex-wrap items-center text-sm text-gray-500 dark:text-gray-400 sm:mb-0">
            <li>
                <a href="" class="mr-4 text-black hover:underline md:mr-6">Jobs</a>
            </li>
            <li>
                <a href="" class="mr-4 text-black hover:underline md:mr-6">Privacy Policy</a>
            </li>
            <li>
                <a href="" class="mr-4 text-black hover:underline md:mr-6">Terms</a>
            </li>
            <li>
                <a href="" class="text-black hover:underline">FAQ</a>
            </li>
        </ul>
    </div>
