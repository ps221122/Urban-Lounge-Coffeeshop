    ...
    function game() {
        ...
        function action(e) {
            ...
            if (playing) {
                ...
                var dist;
                if (gameOver) {
                    dist = Math.sqrt(((e.offsetX - cW / 2) * (e.offsetX - cW / 2)) + ((e.offsetY - (cH / 2 + 45 + 22)) *
                    ...
                    dist = Math.sqrt(((e.offsetX - cW / 2) * (e.offsetX - cW / 2)) + ((e.offsetY - cH / 2) * (e
                        .offsetY - cH / 2)));
        ...
        function _asteroids() {
            ...
            for (var i = 0; i < asteroids.length; i++) {
                if (!asteroids[i].destroyed) {
                    ...
                    //Real Coords
                    asteroids[i].realX = (0) - (asteroids[i].moveY + ((asteroids[i].height / asteroids[i].size) / 2)) *
                        Math.sin(asteroids[i].deg);
                    asteroids[i].realY = (0) + (asteroids[i].moveY + ((asteroids[i].height / asteroids[i].size) / 2)) *
                    ...
                    //Game over
                    distance = Math.sqrt(Math.pow(asteroids[i].realX - cW / 2, 2) + Math.pow(asteroids[i].realY - cH /
                        2, 2));
