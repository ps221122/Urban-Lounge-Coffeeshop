<footer class="body-font border-t-2 border-gray-300 text-gray-600">
    <div
        ...
        <div class="mx-auto mt-10 w-64 flex-shrink-0 text-center md:mx-0 md:mt-0 md:text-left">
            <a class="title-font flex items-center justify-center font-medium text-gray-900 md:justify-start">
                <img src="http://127.0.0.1:8000/assets/logo.png" class="h-10 w-12" alt="" srcset="">
                <span class="ml-3 text-xl">Urban Lounge Coffeeshop</span>
            </a>
            <p class="mt-2 text-sm text-gray-500">Truth is like the sun. You can shut it out for a time, but it ain't
                goin' away.</p>
        </div>
    ...
    <div class="bg-gray-100">
        <div class="container mx-auto flex flex-col flex-wrap py-4 px-5 sm:flex-row">
            <p class="text-center text-sm text-gray-500 sm:text-left">© 2022
                <a href="" rel="noopener noreferrer" class="ml-1 text-gray-600" target="_blank">Urban Lounge
                    Coffeeshop. All rights reserved</a>
            </p>
            <span class="mt-2 inline-flex justify-center sm:ml-auto sm:mt-0 sm:justify-start">
                <a class="ml-3 text-lg">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        class="h-8 w-8 text-blue-800" viewBox="0 0 24 24">
                ...
                <a class="ml-3 text-lg">
                    <svg fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        class="h-8 w-8 fill-blue-500" viewBox="0 0 24 24">
                        <path
                ...
                <a class="ml-3 text-lg">
                    <svg class="h-8 w-8 fill-current text-pink-600" viewBox="0 0 24 24"
                ...
                <a class="ml-3 text-lg">
                    <svg class="h-8 w-8 fill-current text-blue-500" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512">
                        <path
                ...
                <a class='ml-3 text-lg'>
                    <svg class="h-8 w-8 fill-current text-green-400" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512">
                        <path
