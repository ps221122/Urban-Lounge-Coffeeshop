        ...
        @foreach ($jobs as $job)
            <div
                ...
                <div
                    ...
                    <h1 class="title-font job-title mb-4 text-3xl font-medium text-gray-900 sm:text-4xl"> {{ $job->title }}
                    </h1>
                    ...
                    <div class="flex justify-center">
                        <button
                            class="apply-button inline-flex rounded border-0 bg-indigo-500 py-2 px-6 text-lg text-white hover:bg-indigo-600 focus:outline-none">Apply
                            now</button>
                    </div>
                </div>
