            ...
            <ul
                ...
                <li>
                    <ul class="md:flex md:p-0">
                        <li class="open-shopping-cart-box flex cursor-pointer items-center pb-2 font-medium text-black hover:font-bold hover:uppercase hover:underline md:text-lg lg:px-14"
                            onclick="myFunction()">
