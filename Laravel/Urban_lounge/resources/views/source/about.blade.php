    ...
    <section class="about-body">
        ...
        <div class="index-header mt-12 lg:h-screen" id="header">
            <img class="lg:h-full lg:w-full"
                src="https://www.humphreys.nl/mysite/modules/SFIL0100/images/239_humphreys_restaurant_amsterdam_2.jpg"
                alt="image">
            <div class="-mt-3 flex flex-col items-center justify-center">
                <p class="-mt-24 text-base text-white md:text-2xl lg:-mt-96 lg:text-6xl">About us!</p>
                <div class="scroller">
        ...
        <div class="first-paragraaf m-2 lg:m-40">
