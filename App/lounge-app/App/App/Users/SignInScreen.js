    ...
    <ImageBackground style={styles.container} source={{ uri: "https://images.unsplash.com/photo-1564875197268-d336949dc1a9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8M3x8fGVufDB8fHx8&w=1000&q=80" }} resizeMode={'cover'}>
      <View style={styles.shadowProp}>
        ...
        <View style={{ marginBottom: 10, }}>
          <Text style={{ fontSize: 22, color: 'white' }}>Wachtwoord:</Text>
          <TextInput
            style={styles.input}
        ...
        <View>
          <TouchableOpacity style={styles.loginButton}>
            <Text style={styles.loginFont}>Inloggen</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={{ marginLeft: 35, fontSize: 15, }}>
          <TouchableOpacity style={{ flexDirection: 'row' }}>
            <Text style={{ color: 'white' }}>Een account nodig?</Text>
            <Text style={{ textDecorationLine: 'underline', paddingLeft: 3, color: 'white', }} onPress={() => navigation.navigate('SignUpScreen')}>Inschrijven</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ImageBackground>
